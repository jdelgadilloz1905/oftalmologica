        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <p class="bold text-left">Horarios: Lunes a Viernes, 7:30 am a 6:00 pm </p>
                </div>
                <div class="col-sm-6 col-md-6">
                    <p class="bold text-right">Comuníquese con nosotros al +58 212 918.77.77</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container navigation">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="<?php echo $url; ?>">
                <img src="<?php echo $url; ?>img/logo.gif" alt="" width="250" height="50" class="imageOcultar"/>
            </a>
        </div>
